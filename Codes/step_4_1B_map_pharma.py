...
#
# 원칙
# 1) mimic_vars.csv의 direct pharma mapping(pm*, m_pm_*)은 그대로 사용
# 2) Table4 drugs sheet로 추가하는 mapping은
#    master list의 MIMIC varids에 실제 숫자 ITEMID가 있는 pm만 허용
# 3) rate / presence aggregation은 아직 하지 않음
# ============================================================
...
def map_pharma_concepts(
    ...
    # --------------------------------------------------------
    # 2. mimic_vars.csv direct pharma mapping
    #    → master-list MIMIC varids 유무와 관계없이 유지
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # 3. Table4 master list:
    #    MIMIC varids가 실제 숫자로 명시된 pharma ID만 허용
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # 4. Table4 drugs exact-name mapping
    #    단, eligible_pm_ids에 있는 pm만 허용
    # --------------------------------------------------------
    ...
    # --------------------------------------------------------
    # 6. 실제 event rows에 canonical pharma 이름 붙이기
    # --------------------------------------------------------
